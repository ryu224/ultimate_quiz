$(function(){ 
  ...
  const quiz = [
    { 
      question: 'オフェンス戦術の中で、コートに垂直に一列になるものはどれ？',
      answers: [
        'バーティカルスタック',
        'ホライゾンタルスタック',
        'ゾーン',
      ...
      question: 'パスを回す役割であるディスク近くに位置するポジションはどれ？',
      answers: [
        'ガード',
        'ミドル',
        'ハンドラー',
      ...
      question: '利き手側で指を引っ掛けて投げるスローはどれ？',
      answers: [
        'サイドスロー(フォアハンド)',
        'ハンマースロー',
        'バックハンドスロー',
      ...
      correct:'サイドスロー(フォアハンド)'
    },{
      question: '他の人がカバーしているエリアをディフェンスするという意味で、多くはオフェンスでフリーを意味するものは？',
      answers: [
      'アイソレーション',
      'マンツーマン',
      'ポーチ',
      ...
      question: 'オフェンスにおいて、１番最初にディスクを持つ人のことはどれ？',
      answers: [
        'WB',
        'RB',
        'HB',
